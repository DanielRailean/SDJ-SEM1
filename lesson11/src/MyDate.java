...
public class MyDate
{
  ...
  public static MyDate today(){
    ...
    return new MyDate(now.get(GregorianCalendar.DATE),now.get(GregorianCalendar.MONTH)+1,now.get(GregorianCalendar.YEAR));
  }
  public boolean isBefore(MyDate object){
    return (year<object.getYear())||
            ((month<object.getMonth())&&(year==object.getYear()))||
             ((day<object.getDay())&&(month==object.getMonth())&&(year==object.getYear()));
  }
  ...
  public boolean equals(MyDate object){
    return ((object.getDay()==day)&&(object.getMonth()==month)&&(object.getYear()==year));
  }
  public MyDate copy(){
